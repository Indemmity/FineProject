...
const VERB_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/^worked with\b/i, "Worked on"],
  [/^built\b/i, "Built and maintained"],
  [/^developed\b/i, "Developed and maintained"],
  [/^created\b/i, "Created and refined"],
  [/^helped\b/i, "Supported"],
  [/^managed\b/i, "Managed and coordinated"],
  [/^implemented\b/i, "Implemented and improved"],
  [/^designed\b/i, "Designed and delivered"],
  [/^led\b/i, "Led and coordinated"],
  [/^maintained\b/i, "Maintained and improved"],
  [/^improved\b/i, "Improved and optimized"],
];
